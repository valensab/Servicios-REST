...
public class ServicioPersistenciaMock implements IServicioPersistenciaMockRemote, IServicioPersistenciaMockLocal {
    ...
    private static ArrayList<Usuario> usuarios;
     ...
     /**
     * Lista con las ofertas del sistema
     */
    ...
    public ServicioPersistenciaMock()
    {
        if (vendedores == null)
        {
            ...
            //Agregar ofertas del sistema
            ofertas.add(new Oferta(1L, "client", 1, 100000.0));
            ofertas.add(new Oferta(2L, "client", 2, 100000.0));
    ...
    public void create(Object obj) throws OperacionInvalidaException
    {
        ...
        else if (obj instanceof Oferta)
        {
            ...
            Oferta oft = (Oferta) obj;
            oft.setIdOferta(ofertas.size() + 1);
            ofertas.add(oft);
        } 
    }
    ...
    public void delete(Object obj) throws OperacionInvalidaException
    {
        ...
        else if (obj instanceof Oferta)
        {
            ...
            {
                oferta = ofertas.get(i);
                if (eliminar.getIdOferta() == oferta.getOferta())
                {
                    ofertas.remove(i);
                    break;
                }
    ...
    public Object findById(Class c, Object id)
    {
        ...
        else if (c.equals(Oferta.class))
        {
            ...
            {
                Oferta oft = (Oferta) v;
                if (Long.parseLong(id.toString())== oft.getIdOferta())
                {
                    return oft;
                }
            }
